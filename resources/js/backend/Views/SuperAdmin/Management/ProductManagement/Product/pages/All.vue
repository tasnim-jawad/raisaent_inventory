    ...
    >
      <div class="off_canvas_body">
        ...
        <div class="data_content">
          ...
          <div class="filter_item">
            <label for="product_sub_category_id"> Suppliyer</label>
            <label
              for="product_sub_category_id"
              class="text-capitalize d-block date_custom_control"
            >
              <select
                v-model="suppliyer_id"
                id="suppliyer_id"
                name="suppliyer_id"
                class="form-control"
              >
                ...
                <option
                  :value="suppliyer.id"
                  v-for="suppliyer in suppliyers"
                  :key="suppliyer"
                >
                  {{ suppliyer.name.substr(0, 20) }}
                </option>
              </select>
            </label>
          </div>
...
export default {
  ...
  methods: {
    ...
    get_all_suppliers: async function (category_id) {
